    ...
    <div class="nav3">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          ...
          <vxe-table-column field="myPay_time" min-width="160" title="下单时间"></vxe-table-column>
          ...
          <vxe-table-column field="remark" min-width="100" title="备注"></vxe-table-column>
...
export default {
  computed: {
    ...mapState(["jiazhengliebiaoPage", "jiazhengliebiaoPageSize"])
  },
  watch: {
  ...
  methods: {
    async getData() {
      const res = await this.$api.homework_order_list({
      ...
      this.tableData.forEach(ele => {
        ...
        ele.myPay_time = this.formatDate(ele.order_time * 1000);
      });
    },
    changeRad1(val){
      console.log(val)
